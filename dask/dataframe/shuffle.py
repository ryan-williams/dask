...
def set_index(
    ...
    **kwargs,
    ...
    if divisions is None:
        ...
        mins = list(index2.partitions[i].map_partitions(M.min) for i in range(index2.npartitions))
        maxs = list(index2.partitions[i].map_partitions(M.max) for i in range(index2.npartitions))
